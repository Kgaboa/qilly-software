-- ================================================
-- EMERGENCY FIX: CREATE ALL TABLES FROM SCRATCH
-- ================================================
-- SIMPLIFIED VERSION - NO FANCY OUTPUT
-- This DROPS existing broken tables and creates new ones
-- with ALL columns needed for Qilly to work!
...
-- Create suppliers table with ALL columns
...
-- Create contractors table with ALL columns
...
-- Create POPIA consent log table
...
-- Create indexes for POPIA consent log
CREATE INDEX idx_popia_consent_user_id ON popia_consent_log(user_id);
CREATE INDEX idx_popia_consent_type ON popia_consent_log(consent_type);
CREATE INDEX idx_popia_consent_created_at ON popia_consent_log(created_at);
...
SELECT 'suppliers table: 31 columns' as suppliers_info;
SELECT 'contractors table: 33 columns' as contractors_info;
SELECT 'popia_consent_log table: created' as popia_info;
SELECT 'Row Level Security: enabled' as security_info;
